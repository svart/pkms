...
- Statistics, hubs, direct tag usage counts, TODO summaries, orphans,
  suggestions, and unlinked mentions.
...
| `commands/mentions.rs` | Outgoing, incoming, and stdin unlinked-mention reports. |
